...
public class LapotanTransaksiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lapotan_transaksi);
        masterFunction = new MasterFunction(getApplicationContext(),LapotanTransaksiActivity.this);
    ...
    private void getData(){
        Call<List<TransaksiModel>> call = apiService.get_transaksi(masterFunction.get_phone());
        call.enqueue(new Callback<List<TransaksiModel>>() {
            ...
            public void onResponse(@NonNull Call<List<TransaksiModel>> call, @NonNull Response<List<TransaksiModel>> response) {
                Log.d("view_transaksi", ""+new Gson().toJson(response.body()));
