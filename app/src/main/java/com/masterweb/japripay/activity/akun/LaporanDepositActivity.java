...
public class LaporanDepositActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        masterFunction = new MasterFunction(getApplicationContext(),LaporanDepositActivity.this);
    ...
    private void getData(){
        Call<List<TransaksiModel>> call = apiService.get_deposit(masterFunction.get_phone());
