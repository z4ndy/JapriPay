...
import com.masterweb.japripay.classes.adapter.MutasiAdapter;
...
public class MutasiSaldoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        masterFunction = new MasterFunction(getApplicationContext(),MutasiSaldoActivity.this);
        ...
        hargaAdapter = new MutasiAdapter(getApplicationContext(),listDaily);
        list_transaksi.setAdapter(hargaAdapter);
        getData();
        shimmerFrameLayout.startShimmer();
        bulan = findViewById(R.id.mount);
        Calendar cal = Calendar.getInstance();
        SimpleDateFormat mount = new SimpleDateFormat("MMMM yyyy");
        bulan.setText("Bulan : "+mount.format(cal.getTime()));
    ...
    private void getData(){
        Call<List<TransaksiModel>> call = apiService.get_mutasi(masterFunction.get_phone());
